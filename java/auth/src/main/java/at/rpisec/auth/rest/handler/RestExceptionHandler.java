package at.rpisec.auth.rest.handler;

import at.rpisec.auth.exception.DbEntryAlreadyExistsException;
import at.rpisec.auth.exception.DbEntryNotFoundException;
import at.rpisec.auth.rest.controller.ClientRestController;
